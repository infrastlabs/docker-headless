...
#     img="remote-desktop:core-compile"
...
# # +slim,base (remote-desktop,weskit; use docker-headless's)
# slim)
#     repo=registry-1.docker.io
#     # repo=registry.cn-shenzhen.aliyuncs.com #arm64/amd64可以用,只是cr.console.aliyun.com上无多镜像显示
#     img="remote-desktop:base-$ver-slim"
#     # cache
